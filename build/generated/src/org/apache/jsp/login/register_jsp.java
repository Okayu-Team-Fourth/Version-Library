...
public final class register_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <h1 style=\"color: black; margin: 0; text-align: center\">个人信息</h1>\n");
      out.write("        <form action=\"register.action\">\n");
      out.write("            <label><input type=\"text\" name=\"userName\" placeholder=\"用户名\"/></label><br>\n");
      out.write("            \n");
      out.write("            <label><input type=\"text\" name=\"sex\" placeholder=\"性别\" /><br>\n");
      out.write("                <!--<div id=\"jo\">\n");
      out.write("                <select>\n");
      ...
      out.write("                </div>-->\n");
      out.write("            </label>\n");
      out.write("            <label><input type=\"text\" name=\"idnum\" placeholder=\"身份证号\" /></label><br>\n");
      out.write("            <label><input type=\"text\" name=\"telephone\" placeholder=\"电话号码\"/></label><br>\n");
      out.write("            <label><input type=\"password\" name=\"password1\" placeholder=\"密码\" /></label><br>\n");
      out.write("            <label><input type=\"password\" name=\"password2\" placeholder=\"请再一次确认密码\" /></label><br>\n");
      out.write("            <label><input type=\"text\" name=\"balance\" placeholder=\"余额\" /></label><br>\n");
      out.write("            ");
      out.write("\n");
      out.write("            <label><input type=\"text\" name=\"timedeposit\" value=\"0\" readonly=\"readonly\" placeholder=\"定期存款默认为0\"/></label><br>\n");
      out.write("            <input type=\"submit\" value=\"Sign up\" onclick=\"zhuce()\"/>\n");
      out.write("            <p class=\"change_link\" style=\"text-align: center\">\n");
      out.write("                <span class=\"text\">已经拥有账号?</span>\n");
      out.write("                <a href=\"login.jsp\" class=\"to_login\">去登陆</a>\n");
      out.write("            </p>\n");
      out.write("        </form>\n");
      out.write("    </div>\n");
      out.write("</div>\n");
